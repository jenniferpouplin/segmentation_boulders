...
def get_args():
    ...
    parser.add_argument('--loss', default='BCE', type=str) # loss mode # CE or MSE or focal # DO NOT CHANGE :)
...
if __name__ == '__main__':
    ...
    model = UNet(depth=opts.depth, kernel_size=opts.kernel_size, kernel_num=opts.kernel_num, n_classes=1)
    ...
    np.savez(join(exDir, 'loss.npz'), train=loss_train, val=loss_val)
